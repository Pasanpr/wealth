...
interface PayStatementImportProps {
  onComplete: () => void
}

export function PayStatementImport({ onComplete }: PayStatementImportProps) {
          ...
          {importResults.length > 0 && (
            <div className="mb-4 p-4 bg-destructive/10 rounded-lg">
              <div className="flex items-center gap-2 text-destructive mb-2">
                ...
                <span className="font-medium">{importResults.length} file{importResults.length !== 1 ? 's' : ''} skipped</span>
              </div>
      ...
      {step === 'complete' && (
        <div className="space-y-4">
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {importResults.map((result, i) => (
              ...
              >
                ...
                {result.success ? (
                  <span className="text-sm text-green-500">Imported ({result.payDate})</span>
                ) : (
          ...
          <div className="flex justify-end gap-3 pt-4">
            <Button variant="outline" onClick={handleCancel}>Import More</Button>
